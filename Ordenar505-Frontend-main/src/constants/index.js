...
export const tables = [
    { id: 1, name: "Table 1", status: "Ocupado", initial: "AM", seats: 4 },
    { id: 2, name: "Table 2", status: "Disponible", initial: "MB", seats: 6 },
    { id: 3, name: "Table 3", status: "Ocupado", initial: "JS", seats: 2 },
    { id: 4, name: "Table 4", status: "Disponible", initial: "HR", seats: 4 },
    { id: 5, name: "Table 5", status: "Ocupado", initial: "PL", seats: 3 },
    { id: 6, name: "Table 6", status: "Disponible", initial: "RT", seats: 4 },
    { id: 7, name: "Table 7", status: "Ocupado", initial: "LC", seats: 5 },
    { id: 8, name: "Table 8", status: "Disponible", initial: "DP", seats: 5 },
    { id: 9, name: "Table 9", status: "Ocupado", initial: "NK", seats: 6 },
    { id: 10, name: "Table 10", status: "Disponible", initial: "SB", seats: 6 },
    { id: 11, name: "Table 11", status: "Ocupado", initial: "GT", seats: 4 },
    { id: 12, name: "Table 12", status: "Disponible", initial: "JS", seats: 6 },
    { id: 13, name: "Table 13", status: "Ocupado", initial: "EK", seats: 2 },
    { id: 14, name: "Table 14", status: "Disponible", initial: "QN", seats: 6 },
    { id: 15, name: "Table 15", status: "Ocupado", initial: "TW", seats: 3 }
  ];
